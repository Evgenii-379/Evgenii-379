...
⚙️  DevOps-инженер с техническим бэкграундом в автоматизации оборудования и электротехнике.
🎯 Мой предыдущий опыт помогает быстро разбираться в сложных системах и находить оптимальные решения.
